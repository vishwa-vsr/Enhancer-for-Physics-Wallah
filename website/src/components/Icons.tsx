...
// 100% Official Google Chrome Brand Vector Logo
...
// 100% Official Mozilla Firefox Brand Vector Logo
export const FirefoxIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <img
    src={firefoxSvg}
    alt="Mozilla Firefox"
    className={`${className} object-contain select-none pointer-events-none`}
...
// 100% Official Microsoft Edge Brand Vector Logo
