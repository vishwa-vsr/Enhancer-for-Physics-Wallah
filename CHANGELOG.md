...
### Changed & Improved
- **Version Bump & Distribution Package**: Updated extension version to `v1.0.7.2` with fresh compiled dist packages and store zip archives for Chrome, Firefox, and Edge.
